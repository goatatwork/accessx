...
class SetSubscriberId implements ShouldQueue
{
    ...
    {
        $url = config('goldaccess.settings.switchtool_url') . '/api/ports/subscriber_id';
    ...
    {
        \Log::info('Setting subscriber-id for PR:' .
    ...
    {
        return $this->provisioning_record->port->subscriber_id;
    }
