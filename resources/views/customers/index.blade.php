...
<div class="row">
    <div class="col">
        ...
        @foreach ($customers as $customer)
            <div class="media mb-5 ml-5 pb-3 border-bottom {{ ($loop->first) ? 'mt-5' : '' }}">
                                ...
                                <div class="card-body">
                                    @if ($customer->service_locations()->exists())
                                        @if ($customer->service_locations()->count() > 1)
                                            There are multiple service locations for {{ $customer->customer_name }}.
                                            <a href="/customers/{{ $customer->id }}" class="text-info">See the customer page</a> for more details.
                                        @endif
                                    @endif
                                </div>
                            </div>
