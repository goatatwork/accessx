...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Add A Shared Network</li>
    </ol>
</nav>

<div class="row">
    <div class="col-md-10 text-center">
        <h4>Add A Shared Network</h4>
    </div>
</div>
...
<div class="row">
    <div class="col-md-10">
        ...
        <form method="POST" action="/dhcp/shared_networks">
            {{ method_field('POST') }}
            {{ csrf_field() }}
            ...
            <div class="form-group row"> <!-- notes -->
                ...
                <div class="col">
                    <textarea class="form-control" id="notes" name="notes" rows="3" aria-describedby="notes-help" data-autosize></textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col">
                    <a class="btn btn-danger" href="/dhcp">Cancel</a>
                </div>
            </div>
