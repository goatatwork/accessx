...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Add An ONT</li>
    </ol>
</nav>
        ...
        <form method="POST" action="/onts">
            ...
            <div class="form-group"> <!-- input for number_of_pots_lines -->
                ...
                <input
                    ...
                    value="{{ old('number_of_pots_lines') }}"
                >
            ...
            <div class="form-group"> <!-- input for number_of_ethernet_ports -->
                ...
                <input
                    ...
                    value="{{ old('number_of_ethernet_ports') }}"
                >
            ...
            <div class="form-group row">
                ...
                <div class="col">
                    <a class="btn btn-danger" href="/onts">Cancel</a>
                </div>
            </div>
